...
const fetch_signatures_1 = __webpack_require__(172794);
            ...
            switch (callResult.kind) {
                case "value":
                    ...
                    switch (bytesResult.kind) {
                        case "value":
                            const subDecoding = yield this.decodeTransactionWithAdditionalContexts(Object.assign(Object.assign({}, transaction), { input: bytesResult.value.asHex, to: address }), additionalContexts, additionalAllocations, overrideContext);
...
const Codec = __importStar(__webpack_require__(20102));
const Abi = __importStar(__webpack_require__(207651));
const big_js_1 = __importDefault(__webpack_require__(813012));
const web3_utils_1 = __importDefault(__webpack_require__(118269));
